...
| Version  | 1.0.0a0                                                          |
+----------+------------------------------------------------------------------+
| Revision | $Id: 09f0c515a430bf79e85f406a0bd295e3a3186c32 $                  |
+----------+------------------------------------------------------------------+
| Author   | Omega_K2                                                         |
+----------+------------------------------------------------------------------+
...
class ItemParser:
    ...
    'physical_damage' : list[int, int]
        2 element list containing the minimum/maximum physical damage of the item
        (found on weapons)
    ...
    'item_class' : str
        ...
        .. warning::
            ...
            even though all items have an item class, this is only present on weapons
