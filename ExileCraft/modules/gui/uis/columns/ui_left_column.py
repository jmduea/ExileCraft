...
################################################################################
## Form generated from reading UI file 'left_columnAofwVF.ui'
##
...
class Ui_LeftColumn(object):
    def setupUi(self, LeftColumn):
        ...
        LeftColumn.resize(438, 664)
        font = QFont()
        font.setPointSize(14)
        LeftColumn.setFont(font)
        LeftColumn.setStyleSheet(
            ...
            "\n"
            "                                                        Q"
            "ComboBox:!editable, QComboBox::drop-down:editable {\n"
        ...
        self.item_combobox_container.setObjectName("item_combobox_container")
        sizePolicy = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.item_combobox_container.sizePolicy().hasHeightForWidth()
        )
        ...
        font2 = QFont()
        font2.setBold(True)
        self.base_group_label.setFont(font2)
        ...
        self.base_group_combobox.addItem("")
        self.base_group_combobox.addItem("")
        self.base_group_combobox.setObjectName("base_group_combobox")
        font3 = QFont()
        self.base_group_combobox.setFont(font3)
        self.base_group_combobox.setStyleSheet("")
        ...
        self.base_item_label.setObjectName("base_item_label")
        self.base_item_label.setFont(font2)
        ...
        self.item_level_and_quality_container.setObjectName(
            "item_level_and_quality_container"
        )
        sizePolicy1 = QSizePolicy(QSizePolicy.Minimum, QSizePolicy.Maximum)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(
            self.item_level_and_quality_container.sizePolicy().hasHeightForWidth()
        )
        ...
        self.item_level_label.setFont(font2)
        ...
        self.item_level_spinbox.setObjectName("item_level_spinbox")
        ...
        self.item_quality_label.setFont(font2)
        ...
        self.item_quality_spinbox.setObjectName("item_quality_spinbox")
        ...
        self.item_influence_btns_container.setObjectName(
            "item_influence_btns_container"
        )
        sizePolicy.setHeightForWidth(
            self.item_influence_btns_container.sizePolicy().hasHeightForWidth()
        )
        ...
        self.item_influences_label.setObjectName("item_influences_label")
        sizePolicy.setHeightForWidth(
            self.item_influences_label.sizePolicy().hasHeightForWidth()
        )
        self.item_influences_label.setSizePolicy(sizePolicy)
        self.item_influences_label.setFont(font2)
        ...
        self.item_influence_btn_group.setObjectName("item_influence_btn_group")
        ...
        self.crusader_btn.setStyleSheet(
            "QPushButton {\n"
        ...
        icon = QIcon()
        icon.addFile(
            ":/influences/images/influences/crusader_influence.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
        ...
        self.crusader_btn.setFlat(False)
        ...
        icon1 = QIcon()
        icon1.addFile(
            ":/influences/images/influences/elder_influence.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
        ...
        icon2 = QIcon()
        icon2.addFile(
            ":/influences/images/influences/hunter_influence.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
        ...
        self.redeemer_btn.setStyleSheet(
            "QPushButton {\n"
            "                                                        border: 1px solid #000;\n"
            "                                                        border-radius: 4px;\n"
            "                                                        background-color: qlineargradient(x1: 0, y1: 1, x2: 0, y2: 0,\n"
        ...
        icon3 = QIcon()
        icon3.addFile(
            ":/influences/images/influences/redeemer_influence.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
        ...
        icon4 = QIcon()
        icon4.addFile(
            ":/influences/images/influences/shaper_influence.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
        ...
        self.warlord_btn.setStyleSheet(
            "QPushButton {\n"
            "                                                        border: 1px solid #000;\n"
            "                                                        border-radius: 4px;\n"
            "                                                        background-color: qlineargradient(x1: 0, y1: 1, x2: 0, y2: 0,\n"
        ...
        icon5 = QIcon()
        icon5.addFile(
            ":/influences/images/influences/warlord_influence.png",
            QSize(),
            QIcon.Normal,
            QIcon.Off,
        )
        ...
        self.base_item_combobox.currentTextChanged.connect(
            self.item_quality_spinbox.show
        )

        self.menus.setCurrentIndex(1)
        self.crusader_btn.setDefault(False)
    ...
    def retranslateUi(self, LeftColumn):
        ...
        self.base_group_label.setText(
            QCoreApplication.translate("LeftColumn", "Base Group", None)
        )
        self.base_group_combobox.setItemText(
            0, QCoreApplication.translate("LeftColumn", "One Hand Weapons", None)
        )
        self.base_group_combobox.setItemText(
            1, QCoreApplication.translate("LeftColumn", "Two Hand Weapons", None)
        )
        self.base_group_combobox.setItemText(
            2, QCoreApplication.translate("LeftColumn", "Body Armours", None)
        )
        self.base_group_combobox.setItemText(
            3, QCoreApplication.translate("LeftColumn", "Helmets", None)
        )
        self.base_group_combobox.setItemText(
            4, QCoreApplication.translate("LeftColumn", "Gloves", None)
        )
        self.base_group_combobox.setItemText(
            5, QCoreApplication.translate("LeftColumn", "Boots", None)
        )
        self.base_group_combobox.setItemText(
            6, QCoreApplication.translate("LeftColumn", "Shields", None)
        )
        self.base_group_combobox.setItemText(
            7, QCoreApplication.translate("LeftColumn", "Offhands", None)
        )
        self.base_group_combobox.setItemText(
            8, QCoreApplication.translate("LeftColumn", "Flasks", None)
        )
        self.base_group_combobox.setItemText(
            9, QCoreApplication.translate("LeftColumn", "Jewellery", None)
        )
        self.base_group_combobox.setItemText(
            10, QCoreApplication.translate("LeftColumn", "Jewels", None)
        )

        self.base_group_combobox.setPlaceholderText(
            QCoreApplication.translate("LeftColumn", "Select a Base Group", None)
        )
        self.base_label.setText(QCoreApplication.translate("LeftColumn", "Base", None))
        self.base_combobox.setPlaceholderText(
            QCoreApplication.translate("LeftColumn", "Select a Base", None)
        )
        self.base_item_label.setText(
            QCoreApplication.translate("LeftColumn", "Base Item", None)
        )
        self.base_item_combobox.setPlaceholderText(
            QCoreApplication.translate("LeftColumn", "Select a Base Item", None)
        )
        self.item_level_label.setText(
            QCoreApplication.translate("LeftColumn", "Item Level (0-100)", None)
        )
        self.item_quality_label.setText(
            QCoreApplication.translate("LeftColumn", "Item Quality (0-30)", None)
        )
        self.item_influences_label.setText(
            QCoreApplication.translate("LeftColumn", "Set Item Influences (0-2)", None)
        )
        self.crusader_btn.setText(
            QCoreApplication.translate("LeftColumn", "Crusader", None)
        )
        self.elder_btn.setText(QCoreApplication.translate("LeftColumn", "Elder", None))
        self.hunter_btn.setText(
            QCoreApplication.translate("LeftColumn", "Hunter", None)
        )
        self.redeemer_btn.setText(
            QCoreApplication.translate("LeftColumn", "Redeemer", None)
        )
        self.shaper_btn.setText(
            QCoreApplication.translate("LeftColumn", "Shaper", None)
        )
        self.warlord_btn.setText(
            QCoreApplication.translate("LeftColumn", "Warlord", None)
        )
