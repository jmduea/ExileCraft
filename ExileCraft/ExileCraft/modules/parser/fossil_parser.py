...
from modules.parser.path_utils import get_abs_path, get_base_dir, get_rel_path_to_file
...
# Load JSON data
abs_path_to_json = get_abs_path(base_dir, os.path.join(r'ExileCraft\data', 'json', 'fossils.json'))
