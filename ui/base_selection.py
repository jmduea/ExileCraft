...
from PyQt5.QtWidgets import QVBoxLayout, QPushButton, QWidget, QLabel, QGridLayout, QHBoxLayout, QFormLayout

from ExileCraft.constants import BTN_STYLESHEET, LABEL_STYLESHEET, ITEM_CLASS_SUBTYPES, SUBTYPE_DISPLAY_NAMES
...
class BaseSelection(QWidget):
    ...
    base_selected = pyqtSignal(str, str)
